...
for train_index, val_index in loo.split(X_train_frustrated, y_train_frustrated):
...
for train_index, val_index in loo.split(X_train_frus_group, y_train_frus_group):
