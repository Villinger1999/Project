...
axes[0].bar(['Logistic', 'Baseline', 'Decision Tree'], [av_acc_log_f_skf, av_acc_base_f_skf, av_acc_dt_f_skf])
axes[0].set_title('Average Accuracy for Phase')

# Plot the accuracy for the test data for Frustrated
axes[1].bar(['Logistic', 'Baseline', 'Decision Tree'], [test_acc_f_skf, test_acc_base_f_skf, test_acc_dt_f_skf])
